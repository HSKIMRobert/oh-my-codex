...
| Main promotion | one release PR targeting `main`; merge-commit strategy required; release head `dfb72459` and frozen dev `abf2393a` must both be ancestors of merged main | Pending |
